 ...
 */
export const RainbowKitCustomConnectButtonPW = () => {
  useAutoConnect();
  ...
  const { setIsRainbow } = useSharedState();
          ...
          return (
            <>
              {(() => {
                ...
                // I took chain.unsupported out - if (chain.unsupported || chain.id !== configuredNetwork.id) {
                        ...
                        <li>
                          <button
                            ...
                            onClick={() => {
                              ...
                              console.log(configuredNetwork);
                              console.log("chain ID", chain.id);
                              console.log("chain ID", chain.unsupported);
                            }}
                          >
                ...
                return (
                  <div className="px-2 flex justify-end items-center">
                    <div className="flex flex-col items-center mr-1">
                      {chain && <Balance address={account.address} className="min-h-0 h-auto" />}
                      {chain && (
                    ...
                    <div className="dropdown dropdown-end leading-3">
                      <label
                        tabIndex={0}
                        className="btn btn-secondary pl-0 pr-2 shadow-md dropdown-toggle gap-0 !h-auto"
                      >
